...
class Menu(Screen):
    ...
    def confirmacao(self, *args, **kwargs):
        ...
        box = BoxLayout(orientation='vertical', padding=(10*0.4)/0.4, spacing=(10*0.4)/0.4)
        botoes = BoxLayout(padding=(10*0.4)/0.4, spacing=(10*0.4)/0.4)

        pop = Popup(title='Deseja mesmo sair?', content=box, size_hint=(None, None),
                    size=((120*0.4)/0.4, (150*0.4)/0.4))
        ...
        anim = Animation(size=((380*0.4)/0.4, (280*0.4)/0.4), duration=0.5, t='out_back')
        anim.start(pop)
